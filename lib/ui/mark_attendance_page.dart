...
import 'package:mark/services/location_service.dart';
import 'package:mark/services/firebase_storage_service.dart';
import 'package:flutter/material.dart';
import 'package:geolocator/geolocator.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:mark/widgets/cameras.dart';
...
class _MarkAttendancePageState extends State<MarkAttendancePage>
  ...
  Future<void> verifyFace(BuildContext context) async {
    ...
    var statusFace = await imagestorage.check_attendance(_image, widget.userId);
    setState(() {
      _statusFace = statusFace;
  ...
  Future<void> verifyLocation() async {
    ...
    var data = await Apirepository.employee_getdata(widget.userId);
